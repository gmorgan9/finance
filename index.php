...
<div class="content">
  ...
  <div class="card-body">
    <img src="calendar.png" alt="" style="height: 35px; width: 35px;">
...
<div class="card" id="totexp" style="width: 18rem;">
  <div class="card-body">
  <img src="comparrows.png" alt="" style="height: 35px; width: 35px;">
...
<div class="card" id="totinc" style="width: 18rem;">
  <div class="card-body">
  <img src="balance.png" alt="" style="height: 35px; width: 35px;">
